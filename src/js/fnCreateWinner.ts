...
export function createWinner() {
    const c = CreateElement('div', 'winner-str-wrapper');
    c.classList.add('zindexMIN');
    const body = <HTMLElement>document.querySelector('body');
    c.innerHTML = `
    <div class="winners-wrapper">
      <div class="winner-title">Winners</div>
      <div class="winner-bracket winner-bracket-left">(</div>
      <div class="winner-counter">0</div>
      <div class="winner-bracket winner-bracket-right">)</div>
    </div>
  <div class="table-wrapper">
    <div class="head-table"> 
      <div class="head-table-title Num">Num</div>
      <div class="head-table-title Car">Car</div>
      <div class="head-table-title Name">Name</div>
      <div class="head-table-title CountWiner">Count</div>
      <div class="head-table-title Best-Time">Best Time</div>
    </div>
    <div class="wrapper-for-inf">
      <div class="number-winer">
      ...
      <!--
        <li class="inf-winner">
          <div class="model-car">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 1280.000000 640.000000" preserveAspectRatio="xMidYMid meet" fill = "#FFFFFF"class = "model-card">
          ...
          <div class="model-name">tesla-huesla</div>
          <div class="model-best-time">10</div>
        </li>
        -->
      </ol>
    </div>
